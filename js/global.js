...
/*-------------------------------------------------------------------------------------------------------------------------------*/
/* Template Name: DogoTogo*/
/* Version: 2.0 Initial Release*/
/* Build Date: 01-02-2017*/
/* Author: Taras Bronytskyy*/
/* Website: http://www.dogotogo.com/
/* Copyright: (C) 2017 */
/*-------------------------------------------------------------------------------------------------------------------------------*/
...
jQuery(function($) {
	...
	$(window).on("scroll", function() {
		if($(window).scrollTop()> 80){			
			...
			$('.main-menu-wrapp').addClass('main-menu-change');
		}
		else{
			$('header').removeClass('stick');
			$('.main-menu-wrapp').removeClass('main-menu-change');
		}	
	});		
	...
	function initSwiper(){
		...
		$('.swiper-container.swiper-control-top').each(function(){
			swipers['swiper-'+$(this).attr('id')].params.control = swipers['swiper-'+$(this).closest('.mega-swiper-wrapper').find('.swiper-control-bottom').attr('id')];
		});
		$('.swiper-container.swiper-control-bottom').each(function(){
			swipers['swiper-'+$(this).attr('id')].params.control = swipers['swiper-'+$(this).closest('.mega-swiper-wrapper').find('.swiper-control-top').attr('id')];
		});
	};
	...
	$('.tt-nav-tab-item').on('click', function(){		
	    ...
	    $t.closest('.tt-tab-wrapper').find('.tt-tab-info:visible').fadeOut(200, function(){
